...
export const Nav = () => {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <a href="#" className="flex items-center space-x-1 group z-[60]">
          <span className="text-xl md:text-2xl font-serif font-semibold tracking-wide text-cream transition-colors duration-300">
            Axelo
          </span>
          <span className="text-xl md:text-2xl font-serif text-gold italic font-medium transition-colors duration-300">
            Safari Suite
          </span>
        </a>
        ...
        <div className="hidden md:block">
          <MagneticButton className="shimmer-btn bg-gold hover:bg-gold-light text-cream font-mono text-xs tracking-wider uppercase px-6 py-3 rounded-[8px] border border-gold transition-colors duration-300 select-none shadow-lg shadow-gold/10">
            Book a Demo
          </MagneticButton>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Mobile Footer Area */}
            <div className="absolute bottom-8 left-8 right-8 flex items-center justify-between border-t border-border-warm pt-4 text-xs font-mono text-cream-muted">
